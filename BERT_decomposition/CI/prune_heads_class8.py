...
correct_num = []
correct_num_neg = []
for i in range(1, len(get_sorted_indices_except_max(class_8_data)) + 1):
    print('pruned head num: ', i)
    prune_head_index = get_sorted_indices_except_max(class_8_data)[:i] #  1 to 43개의 head를 prune
    ...
    # print(con[7]) # TP
    # print(con_vertical[7]) # TP+ FP

    correct_num.append(con_diag[7].item())
    correct_num_neg.append(con_vertical[7].item() - con_diag[7].item())
    # for i in range(10):
    #     print(con[i])
