...
correct_num = []
correct_num_neg = []
for i in range(1, len(get_sorted_indices_except_max(class_10_data)) + 1):
    print('pruned head num: ', i)
    prune_head_index = get_sorted_indices_except_max(class_10_data)[:i] #  1 to 43개의 head를 prune
    ...
    # print(con[9]) # TP
    # print(con_vertical[9]) # TP+ FP

    correct_num.append(con_diag[9].item())
    correct_num_neg.append(con_vertical[9].item() - con_diag[9].item())
    # for i in range(10):
    #     print(con[i])
